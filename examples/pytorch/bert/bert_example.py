...
def main():
    ...
    parser.add_argument('--ths_path', type=str, default='./lib/libth_transformer.so',
                        help='path of the pyt_flover dynamic lib file')
    ...
    with torch.no_grad():
        ...
        if args['time']:
            ...
            if rank == 0:
                ...
                print("[INFO] flover time costs:     {:.2f} ms".format(t2 * 1000 / iterations))
                print("[INFO] EFF-flover time costs: {:.2f} ms".format(t3 * 1000 / iterations))
