...
if __name__ == "__main__":
    ...
    parser.add_argument('-lib_path', '--lib_path', type=str, default="/workspace/flover/build/lib/libth_transformer.so", metavar='STRING',
                        help='the path of flover pytorch t5 op library.')
