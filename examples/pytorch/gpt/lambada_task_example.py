...
def main():
    ...
    parser.add_argument("--checkpoint-path", type=str, required=True, help="Path to flover checkpoint dir")
    parser.add_argument("--lib-path", type=str, required=True, help="Path of flover PyTorch GPT op library")
    parser.add_argument(
        "--config-ini-path",
        type=str,
