...
class GptLayerWeights:
    ...
    def __init__(self,
        ...
        if self.int8_mode == 1:
            quant = torch.ops.flover.symmetric_quantize_last_axis_of_batched_matrix
...
class GptContextDecoder(FtModuleBase):
    ...
    def _initialize_model(self, force_init=False):
        ...
        self.ft_op = torch.classes.flover.ParallelGptContextDecoderOp(
            self.num_heads,
            self.size_per_head,
            self.inter_size,
            self.num_layers,
...
class GptDecoder(FtModuleBase):
    ...
    def _initialize_model(self, force_init=False):
        ...
        if self.ft_op is not None:
            del self.ft_op
        self.ft_op = torch.classes.flover.ParallelGptDecoderOp(
            self.num_heads,
            self.size_per_head,
            self.inter_size,
            self.num_layers,
...
class Gpt:
    ...
    def __init__(self,
        ...
        self.decode_op = torch.classes.flover.DynamicDecodeOp(
            self.vocab_size,
    ...
    def generate(self,
        ...
        if use_shared_contexts:
            find_context_duplications = torch.ops.flover.find_context_duplications
