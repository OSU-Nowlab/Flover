...
def main():
    ...
    parser.add_argument(
        "--vocab-path",
        help="Path to vocabulary file to embed in flover checkpoint",
        required=False,
    )
    parser.add_argument(
        "--merges-path",
        help="Path to merges file to embed in flover checkpoint",
        required=False,
    )
    parser.add_argument(
        "--tokenizer-model-path",
        help="Path to tokenizer model file to embed in flover checkpoint",
        required=False,
    )
