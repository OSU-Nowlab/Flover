...
class GPTFp8Weights(object):
    def __init__(self, head_num, size_per_head, layer_num, vocab_size, max_seq_len, tensor_para_size, pipeline_para_size,
        ...
        if int8_mode != 0:
            self.weight_transpose_calibrate_quantize = torch.ops.flover.weight_transpose_calibrate_quantize
...
class GPTFp8(nn.Module):
    def __init__(self,
        ...
        self.model = torch.classes.flover.GptFp8Op(self.head_num, self.size_per_head, 4 * self.head_num * self.size_per_head,
