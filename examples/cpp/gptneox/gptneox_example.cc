...
#include "src/flover/models/gptneox/GptNeoX.h"
...
void gptneox_example(const INIReader reader)
{
    ...
    flover::PromptLearningType prompt_learning_type =
        static_cast<flover::PromptLearningType>(reader.GetInteger(model_name, "prompt_learning_type", 0));
    ...
    flover::GptNeoXWeight<T> gpt_weights(hidden_units,
                                                    inter_size,
                                                    vocab_size,
                                                    decoder_layers,
