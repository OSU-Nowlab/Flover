...
#include "src/flover/triton_backend/multi_gpu_gpt_fp8/ParallelGptFP8TritonModel.h"
#include "src/flover/triton_backend/multi_gpu_gpt_fp8/ParallelGptFP8TritonModelInstance.h"
                  ...
                  const int                                                         device_id)
{
    ...
    *output_tensors = (*model_instance)->forward(request);
    // flover::print_to_screen((int*)output_tensors[0].get()->at("output_ids").data, 10);
    return 0;
}
