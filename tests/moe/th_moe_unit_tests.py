...
class TestGroupedGemmBias(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.unpack_packed_int4s = torch.ops.flover.unpack_int4_packed_tensor_to_int8
        self.pack_int4s = torch.ops.flover.pack_int8_tensor_to_packed_int4
        self.preprocess_weights_for_mixed_gemm = torch.ops.flover.preprocess_weights_for_mixed_gemm

        self.symmetric_quantizer = torch.ops.flover._symmetric_quantize_last_axis_of_batched_matrix
        self.add_bias_and_interleave_int4s = torch.ops.flover._add_bias_and_interleave_int4s
        self.add_bias_and_interleave_int8s = torch.ops.flover._add_bias_and_interleave_int8s
