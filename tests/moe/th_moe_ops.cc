...
#include "src/flover/kernels/cutlass_kernels/moe_gemm/moe_gemm_kernels.h"
#include "src/flover/kernels/moe_kernels.h"
#include "src/flover/th_op/th_utils.h"
#include "src/flover/utils/cuda_bf16_wrapper.h"
...
std::vector<Tensor> gating_softmax_torch(Tensor input, int64_t k)
{
    ...
    switch (_st) {
        case at::ScalarType::Float: {
            ...
            flover::topk_gating_softmax_kernelLauncher<float>(
        ...
        case at::ScalarType::Half: {
            ...
            flover::topk_gating_softmax_kernelLauncher<half>(
                input_ptr, nullptr, max_vals, softmax_out_ptr, idx_ptr, rows_ptr, m, num_experts, k, stream);
            return {max_values, indices, rows};
        }
#ifdef ENABLE_BF16
        case torch::kBFloat16: {
            ...
            flover::topk_gating_softmax_kernelLauncher<__nv_bfloat16>(
                input_ptr, nullptr, max_vals, softmax_out_ptr, idx_ptr, rows_ptr, m, num_experts, k, stream);
            return {max_values, indices, rows};
        }
#endif
...
Tensor grouped_gemm_bias_helper(Tensor                            activations,
                                ...
                                flover::ActivationType activation_type)
{
    ...
    flover::MoeGemmRunner<T, WeightType> moe_gemm_runner;
                         ...
                         std::string activation_type_str)
{
    ...
    flover::ActivationType activation_type = flover::ActivationType::InvalidType;
    if (activation_type_str == "identity") {
        activation_type = flover::ActivationType::Identity;
    }
    else {
        activation_type = flover::getActivationType(activation_type_str);
    }
...
Tensor run_moe_fc_helper(Tensor                            input_activations,
                         ...
                         flover::ActivationType fc1_activation_type,
                         ...
                         const int                         k)
{
    ...
    flover::CutlassMoeFCRunner<T, WeightType> moe_runner;
    ...
    flover::finalize_moe_routing_kernelLauncher(fc2_output_ptr,
                                                           output_tensor_ptr,
                                                           skip_layer_ptr,
                  ...
                  int64_t     k)
{
    ...
    flover::ActivationType fc1_activation_type = flover::ActivationType::InvalidType;
    if (fc1_activation_type_str == "identity") {
        fc1_activation_type = flover::ActivationType::Identity;
    }
    else {
        fc1_activation_type = flover::getActivationType(fc1_activation_type_str);
    }
