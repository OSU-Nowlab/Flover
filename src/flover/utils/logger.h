...
#include "src/flover/utils/string_utils.h"
...
#define FT_LOG(level, ...) flover::Logger::getLogger().log(level, __VA_ARGS__)
#define FT_LOG_TRACE(...) FT_LOG(flover::Logger::TRACE, __VA_ARGS__)
#define FT_LOG_DEBUG(...) FT_LOG(flover::Logger::DEBUG, __VA_ARGS__)
#define FT_LOG_INFO(...) FT_LOG(flover::Logger::INFO, __VA_ARGS__)
#define FT_LOG_WARNING(...) FT_LOG(flover::Logger::WARNING, __VA_ARGS__)
#define FT_LOG_ERROR(...) FT_LOG(flover::Logger::ERROR, __VA_ARGS__)
}  // namespace flover
