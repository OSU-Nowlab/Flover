...
#include "src/flover/kernels/decoder_masked_multihead_attention.h"
#include "src/flover/utils/logger.h"
    ...
    int8_mode_(int8_mode)
{
    FT_CHECK(size_per_head_ == 32 || size_per_head_ == 48 || size_per_head_ == 64 || size_per_head_ == 80
             || size_per_head_ == 96 || size_per_head_ == 112 || size_per_head_ == 128 || size_per_head_ == 144 || size_per_head_ == 160
                                           ...
                                           const AttentionWeight<T>* attention_weights)
{
    ...
    POP_RANGE;
    // std::cout<<batch_size<<" "<<beam_width<<" "<<local_head_num_<<" "<<size_per_head_<<" "<<memory_max_len<<" "<<input_tensors->getVal<int>("max_input_length", 0)<<" "<<input_tensors->getVal<int>("step")<<std::endl;
