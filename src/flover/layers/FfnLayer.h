...
#include "src/flover/kernels/activation_kernels.h"
#include "src/flover/kernels/cutlass_kernels/fpA_intB_gemm/fpA_intB_gemm.h"
#include "src/flover/kernels/cutlass_kernels/int8_gemm/int8_gemm.h"
#include "src/flover/kernels/matrix_vector_multiplication.h"
#include "src/flover/kernels/moe_kernels.h"
#include "src/flover/layers/BaseLayer.h"
#include "src/flover/layers/FfnWeight.h"
#include "src/flover/utils/activation_types.h"
...
public:
    ...
    */
    ...
    virtual void forward(std::vector<flover::Tensor>*       output_tensors,
