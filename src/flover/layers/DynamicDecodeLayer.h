...
#include "src/flover/kernels/beam_search_topk_kernels.h"
#include "src/flover/layers/BaseLayer.h"
#include "src/flover/layers/DynamicDecodeBaseLayer.h"
...
public:
    TopKSamplingLayer<T>* topk_decode_;
    TopPSamplingLayer<T>* topp_decode_;
