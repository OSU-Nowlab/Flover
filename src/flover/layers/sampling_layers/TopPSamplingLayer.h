...
#include "src/flover/layers/sampling_layers/BaseSamplingLayer.h"
...
public:
    ...
    using BaseSamplingLayer<T>::temperature_buf_;
    using BaseSamplingLayer<T>::repetition_penalty_buf_;
    using BaseSamplingLayer<T>::min_lengths_buf_;
