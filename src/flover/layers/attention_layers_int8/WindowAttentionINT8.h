...
#include "src/flover/kernels/layout_transformer_int8_kernels.h"
#include "src/flover/kernels/normalize_kernels.h"
#include "src/flover/kernels/reverse_roll_kernels.h"
#include "src/flover/kernels/softmax_int8_kernels.h"
#include "src/flover/kernels/transform_mask_kernels.h"
#include "src/flover/kernels/transpose_int8_kernels.h"
#include "src/flover/kernels/unfused_attention_int8_kernels.h"
#include "src/flover/layers/attention_layers/BaseAttentionLayer.h"
#include "src/flover/models/swin_int8/SwinINT8Weight.h"
#include "src/flover/utils/Tensor.h"
#include "src/flover/utils/cublasINT8MMWrapper.h"
