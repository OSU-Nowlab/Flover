...
#include "src/flover/th_op/deberta/DebertaOp.h"

namespace th = torch;
namespace torch_ext {

floverDeberta::floverDeberta(th::Tensor q_kernel,
                                                   th::Tensor q_bias,
                                                   th::Tensor k_kernel,
                                                   th::Tensor k_bias,
                                                   th::Tensor v_kernel,
...
floverDeberta::~floverDeberta()
{
    delete ftdeberta;
}

th::Tensor floverDeberta::forward(th::Tensor input, th::Tensor sequence_lengths)
{
...
std::vector<th::Tensor> floverDeberta::get_pickle_info() const
{
...
static auto floverDebertaTHS =
#ifdef LEGACY_THS
    torch::jit::class_<torch_ext::floverDeberta>("floverDeberta")
#else
    torch::jit::class_<torch_ext::floverDeberta>("flover", "Deberta")
#endif
        .def(torch::jit::init<th::Tensor,
                              ...
                              int64_t,
                              int64_t>())
        .def("forward", &torch_ext::floverDeberta::forward)
        .def_pickle(
            [](const c10::intrusive_ptr<torch_ext::floverDeberta>& self) -> std::vector<th::Tensor> {
                return self->get_pickle_info();
            },
            [](std::vector<th::Tensor> state) -> c10::intrusive_ptr<torch_ext::floverDeberta> {
                ...
                return c10::make_intrusive<torch_ext::floverDeberta>(state[0],
                                                                                state[1],
                                                                                state[2],
                                                                                state[3],
                                                                                state[4],
