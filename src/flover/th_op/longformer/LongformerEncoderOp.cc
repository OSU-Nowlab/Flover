...
floverLongformerEncoder::floverLongformerEncoder(int64_t layer_num,
                                                                       int64_t in_dim,
                                                                       int64_t head_num,
...
floverLongformerEncoder::~floverLongformerEncoder()
{
...
th::Tensor floverLongformerEncoder::forward(
...
static auto floverLongformerEncoderTHS =
#ifdef LEGACY_THS
    torch::jit::class_<torch_ext::floverLongformerEncoder>("floverLongformerEncoder")
#else
    torch::jit::class_<torch_ext::floverLongformerEncoder>("flover", "LongformerEncoder")
#endif
        .def(
            torch::jit::init<int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, double>())
        .def("forward", &torch_ext::floverLongformerEncoder::forward);
