...
#include "src/flover/models/longformer/LongformerEncoder.h"
...
class floverLongformerEncoder: public th::jit::CustomClassHolder {
private:
    size_t layer_num_;
    size_t in_dim_;
    size_t head_num_;
...
public:
    floverLongformerEncoder(int64_t layer_num,
                                       int64_t in_dim,
                                       int64_t head_num,
