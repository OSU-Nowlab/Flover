...
#include "src/flover/th_op/common/DynamicDecodeOp.h"
...
#ifdef LEGACY_THS
    torch::jit::class_<torch_ext::DynamicDecodeOp>("floverDynamicDecodeOp")
#else
    torch::jit::class_<torch_ext::DynamicDecodeOp>("flover", "DynamicDecodeOp")
#endif
