...
static auto gen_relative_pos_bias =
    torch::RegisterOperators("flover::gen_relative_pos_bias", &torch_ext::gen_relative_pos_bias);

static auto transform_trt_mask =
    torch::RegisterOperators("flover::transform_trt_mask", &torch_ext::transform_trt_mask);