...
#include "src/flover/th_op/multi_gpu_gpt/ParallelGptContextDecoderOp.h"
...
static auto floverGptContextDecoderTHS =
#ifdef LEGACY_THS
    torch::jit::class_<torch_ext::ParallelGptContextDecoderOp>("floverParallelGptContextDecoderOp")
#else
    torch::jit::class_<torch_ext::ParallelGptContextDecoderOp>("flover", "ParallelGptContextDecoderOp")
#endif
