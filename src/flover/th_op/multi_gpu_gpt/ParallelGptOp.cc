...
#include "src/flover/th_op/multi_gpu_gpt/ParallelGptOp.h"
...
static auto floverGptTHS =
#ifdef LEGACY_THS
    torch::jit::class_<torch_ext::ParallelGptOp>("floverParallelGptOp")
#else
    torch::jit::class_<torch_ext::ParallelGptOp>("flover", "ParallelGptOp")
#endif
