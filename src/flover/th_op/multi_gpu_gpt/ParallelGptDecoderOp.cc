...
#include "src/flover/th_op/multi_gpu_gpt/ParallelGptDecoderOp.h"
...
static auto floverGptDecoderTHS =
#ifdef LEGACY_THS
    torch::jit::class_<torch_ext::ParallelGptDecoderOp>("floverParallelGptDecoderOp")
#else
    torch::jit::class_<torch_ext::ParallelGptDecoderOp>("flover", "ParallelGptDecoderOp")
#endif
