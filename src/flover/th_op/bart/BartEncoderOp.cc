...
#include "src/flover/th_op/bart/BartEncoderOp.h"

namespace th = torch;
namespace torch_ext {

floverBartEncoder::floverBartEncoder(th::Tensor  attr_output_layernorm_gamma,
                                                           th::Tensor  q_kernel,
                                                           th::Tensor  k_kernel,
                                                           th::Tensor  v_kernel,
...
floverBartEncoder::~floverBartEncoder()
{
    delete ft_bart_encoder;
}

th::Tensor floverBartEncoder::forward(th::optional<th::Tensor> input_ids,
...
std::vector<th::Tensor> floverBartEncoder::get_pickle_info() const
{
...
static auto floverBartEncoderTHS =
#ifdef LEGACY_THS
    torch::jit::class_<torch_ext::floverBartEncoder>("floverBartEncoder")
#else
    torch::jit::class_<torch_ext::floverBartEncoder>("flover", "BartEncoder")
#endif
        .def(torch::jit::init<th::Tensor,
                              ...
                              std::string,
                              std::string>())
        .def("forward", &torch_ext::floverBartEncoder::forward);
