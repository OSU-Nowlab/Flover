...
#include "src/flover/kernels/gen_relative_pos_bias.h"
#include "src/flover/models/bart/BartDecoder.h"
...
public:
                 ...
                 th::Tensor& relative_attention_bias_tensor) override
    {
        ...
        flover::Allocator<ft::AllocatorType::TH>* allocator =
            new flover::Allocator<ft::AllocatorType::TH>();
...
// clang-format off
class floverBartDecoder: public th::jit::CustomClassHolder {
public:
    floverBartDecoder(th::Tensor  self_layernorm_gamma,   // [0] Layer: self-attn LN weight
