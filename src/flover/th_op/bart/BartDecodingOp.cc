...
#include "src/flover/th_op/bart/BartDecodingOp.h"

namespace th = torch;

namespace torch_ext {

floverBartDecoding::floverBartDecoding(int64_t     head_num,
...
floverBartDecoding::~floverBartDecoding()
{
    delete ftdecoding;
}

std::vector<th::Tensor> floverBartDecoding::forward(th::optional<int64_t> beam_width,
                                                               int64_t               max_seq_len,
...
std::vector<th::Tensor> floverBartDecoding::get_pickle_info() const
{
...
static auto floverBartDecodingTHS =
#ifdef LEGACY_THS
    torch::jit::class_<torch_ext::floverBartDecoding>("floverBartDecoding")
#else
    torch::jit::class_<torch_ext::floverBartDecoding>("flover", "BartDecoding")
#endif
        .def(torch::jit::init<int64_t,
                              ...
                              th::Tensor,
                              th::Tensor>())
        .def("forward", &torch_ext::floverBartDecoding::forward);