...
#include "src/flover/th_op/t5/T5DecodingOp.h"
...
floverT5Decoding::floverT5Decoding(int64_t              head_num,
                                                         int64_t              size_per_head,
                                                         int64_t              inter_size,
                                                         int64_t              mem_d_model,
                                                         int64_t              d_model,
...
floverT5Decoding::~floverT5Decoding()
{
    delete ftdecoding;
}

std::vector<th::Tensor> floverT5Decoding::forward(th::optional<int64_t>    beam_width,
                                                             int64_t                  max_seq_len,
...
std::vector<th::Tensor> floverT5Decoding::get_pickle_info() const
{
...
static auto floverT5DecodingTHS =
#ifdef LEGACY_THS
    torch::jit::class_<torch_ext::floverT5Decoding>("floverT5Decoding")
#else
    torch::jit::class_<torch_ext::floverT5Decoding>("flover", "T5Decoding")
#endif
        .def(torch::jit::init<int64_t,
                              ...
                              th::Tensor,
                              th::Tensor>())
        .def("forward", &torch_ext::floverT5Decoding::forward);
