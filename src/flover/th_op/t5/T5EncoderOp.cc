...
#include "src/flover/th_op/t5/T5EncoderOp.h"
...
floverT5Encoder::floverT5Encoder(th::Tensor           attr_output_layernorm_gamma,
                                                       th::Tensor           q_kernel,
                                                       th::Tensor           k_kernel,
                                                       th::Tensor           v_kernel,
...
floverT5Encoder::~floverT5Encoder()
{
    delete ft_t5_encoder;
}

th::Tensor floverT5Encoder::forward(th::optional<th::Tensor> input_ids,
                                               th::Tensor               sequence_lengths,
                                               th::optional<th::Tensor> inputs_embeds)
{
...
std::vector<th::Tensor> floverT5Encoder::get_pickle_info() const
{
...
static auto floverT5EncoderTHS =
#ifdef LEGACY_THS
    torch::jit::class_<torch_ext::floverT5Encoder>("floverT5Encoder")
#else
    torch::jit::class_<torch_ext::floverT5Encoder>("flover", "T5Encoder")
#endif
        .def(torch::jit::init<th::Tensor,
                              ...
                              int64_t,
                              std::string>())
        .def("forward", &torch_ext::floverT5Encoder::forward);
