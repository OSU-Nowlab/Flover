...
#include "src/flover/th_op/t5/T5DecoderOp.h"

namespace th = torch;
namespace torch_ext {

floverT5Decoder::floverT5Decoder(th::Tensor           self_layernorm_gamma,
...
floverT5Decoder::~floverT5Decoder()
{
    delete ftdecoder;
}

std::vector<th::Tensor> floverT5Decoder::forward(int64_t    step,
...
#ifdef LEGACY_THS
    torch::jit::class_<torch_ext::floverT5Decoder>("floverT5Decoder")
#else
    torch::jit::class_<torch_ext::floverT5Decoder>("flover", "T5Decoder")
#endif
        .def(torch::jit::init<th::Tensor,
                              ...
                              int64_t,
                              std::vector<int64_t>>())
        .def("forward", &torch_ext::floverT5Decoder::forward);
