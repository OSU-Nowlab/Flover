...
#include "src/flover/th_op/decoding/DecodingOp.h"
...
floverDecoding::floverDecoding(int64_t    head_num,
...
floverDecoding::~floverDecoding()
{
    delete ftdecoding;
}

std::vector<th::Tensor> floverDecoding::forward(int64_t    beam_width,
                                                           int64_t    max_seq_len,
                                                           th::Tensor memory,
...
std::vector<th::Tensor> floverDecoding::get_pickle_info() const
{
...
static auto floverDecodingTHS =
#ifdef LEGACY_THS
    torch::jit::class_<torch_ext::floverDecoding>("floverDecoding")
#else
    torch::jit::class_<torch_ext::floverDecoding>("flover", "Decoding")
#endif
        .def(torch::jit::init<int64_t,
                              ...
                              th::Tensor,
                              th::Tensor>())
        .def("forward", &torch_ext::floverDecoding::forward)
        .def_pickle(
            [](const c10::intrusive_ptr<torch_ext::floverDecoding>& self) -> std::vector<th::Tensor> {
                return self->get_pickle_info();
            },
            [](std::vector<th::Tensor> state) -> c10::intrusive_ptr<torch_ext::floverDecoding> {
                ...
                return c10::make_intrusive<torch_ext::floverDecoding>(head_num,
                                                                                 size_per_head,
                                                                                 inter_size,
                                                                                 mem_hidden_dim,
                                                                                 layer_num,
