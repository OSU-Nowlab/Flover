...
#include "src/flover/th_op/decoding/GatherTreeOp.h"
...
gather_tree(th::Tensor step_ids, th::Tensor parent_ids, th::Tensor max_sequence_lengths, th::Tensor end_tokens)
{
    ...
    flover::invokeGatherTree(torch_ext::get_ptr<int>(beams),
...
static auto gather_tree = th::RegisterOperators("flover::gather_tree", &torch_ext::gather_tree);