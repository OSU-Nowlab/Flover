...
#include "src/flover/th_op/bert/BertINT8Op.h"

namespace th = torch;

namespace torch_ext {

floverINT8Bert::floverINT8Bert(th::Tensor q_kernel,
                                                     th::Tensor q_bias,
                                                     th::Tensor k_kernel,
                                                     th::Tensor k_bias,
                                                     th::Tensor v_kernel,
...
floverINT8Bert::~floverINT8Bert()
{
    delete ftbert;
}

th::Tensor floverINT8Bert::forward(th::Tensor input, th::Tensor sequence_lengths)
{
...
std::vector<th::Tensor> floverINT8Bert::get_pickle_info() const
{
...
static auto floverINT8BertTHS =
#ifdef LEGACY_THS
    torch::jit::class_<torch_ext::floverINT8Bert>("floverINT8Bert")
#else
    torch::jit::class_<torch_ext::floverINT8Bert>("flover", "INT8Bert")
#endif
        .def(torch::jit::init<th::Tensor,
                              ...
                              bool,
                              double>())
        .def("forward", &torch_ext::floverINT8Bert::forward)
        .def_pickle(
            [](const c10::intrusive_ptr<torch_ext::floverINT8Bert>& self) -> std::vector<th::Tensor> {
                return self->get_pickle_info();
            },
            [](std::vector<th::Tensor> state) -> c10::intrusive_ptr<torch_ext::floverINT8Bert> {
                ...
                return c10::make_intrusive<torch_ext::floverINT8Bert>(state[0],
                                                                                 state[1],
                                                                                 state[2],
                                                                                 state[3],
                                                                                 state[4],
