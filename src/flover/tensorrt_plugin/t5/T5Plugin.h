...
#include "src/flover/models/t5/T5Decoding.h"
#include "src/flover/models/t5/T5DecodingWeight.h"
#include "src/flover/models/t5/T5Encoder.h"
...
private:
    ...
    struct {
        ...
        flover::ActivationType activation_type              = flover::ActivationType::Relu;
