...
#include "src/flover/kernels/cutlass_kernels/cutlass_heuristic.h"
                                       ...
                                       int*              occupancy = nullptr)
{
    ...
    throw std::runtime_error(
        "[FT Error][fpA_intB] flover was built was mixed gemm support off. Please rebuild with cmake option -DBUILD_CUTLASS_MIXED_GEMM=ON");
#endif
}
