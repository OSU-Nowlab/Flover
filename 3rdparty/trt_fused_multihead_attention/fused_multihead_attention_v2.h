...
public:
                     ...
                     bool                                 causal_mask     = false) const
    {
        ...
        if (params.interleaved) {
            assert(mDataType == flover::DATA_TYPE_INT8);
        }
        ...
        if (!forceUnroll && !params.ignore_b1opt && mSM >= kSM_75) {
            const struct {
                ...
                {kSM_75, flover::DATA_TYPE_FP16, 128, 32, 1},
                {kSM_75, flover::DATA_TYPE_FP16, 128, 40, 1},
                {kSM_75, flover::DATA_TYPE_FP16, 128, 64, 1},
                {kSM_75, flover::DATA_TYPE_FP16, 256, 64, 1},
                {kSM_75, flover::DATA_TYPE_FP16, 384, 64, 1},
                {kSM_75, flover::DATA_TYPE_INT8, 128, 64, 1},
                {kSM_75, flover::DATA_TYPE_INT8, 192, 64, 2},
                {kSM_75, flover::DATA_TYPE_INT8, 256, 64, 1},
                {kSM_75, flover::DATA_TYPE_INT8, 384, 64, 1},
#if CUDA_VERSION >= 11000
                {kSM_80, flover::DATA_TYPE_INT8, 192, 64, 16},
                {kSM_80, flover::DATA_TYPE_INT8, 256, 64, 8},
                {kSM_80, flover::DATA_TYPE_INT8, 384, 64, 8},

                {kSM_86, flover::DATA_TYPE_FP16, 128, 32, 4},
                {kSM_86, flover::DATA_TYPE_FP16, 128, 40, 4},
                {kSM_86, flover::DATA_TYPE_FP16, 128, 64, 4},
                {kSM_86, flover::DATA_TYPE_FP16, 256, 64, 4},
                {kSM_86, flover::DATA_TYPE_INT8, 128, 64, 4},
                {kSM_86, flover::DATA_TYPE_INT8, 192, 64, 16},
                {kSM_86, flover::DATA_TYPE_INT8, 256, 64, 8},
                {kSM_86, flover::DATA_TYPE_INT8, 384, 64, 8},
#endif
            };
